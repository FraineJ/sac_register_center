...
class TariffService {
    ...
    async list() {
        try {
            const response = await apiClient.get(BACKEND_ENDPOINTS.GET_TARIFF);
    ...
    async listById(id: number) {
        try {
            const response = await apiClient.get(`${BACKEND_ENDPOINTS.GET_TARIFF}/${id}`);
    ...
    async update(id: number, data: any,) {
        try {
            const response = await apiClient.put(`${BACKEND_ENDPOINTS.UPDATE_TARIFF}/${id}`, data);
    ...
    async delete(id: number) {
        try {
            const response = await apiClient.delete(`${BACKEND_ENDPOINTS.DELETE_TARIFF}/${id}`);
