...
const Fleet = () => {
  ...
  const resetForm = () => {
    ...
    setSelectedFiles(null);
    setUploadedImage(null);
    setDocuments([{ file: null, expirationDate: '', id: '1', expires: true, listDocumentId: '' }]);
    setShowForm(false);
    setEditingVessel(null);
  };
  ...
  const editVessel = (vessel: any) => {
    ...
    if (vessel.documents && vessel.documents.length > 0) {
      ...
      setDocuments([{ id: '1', file: null, expirationDate: '', name: '', type: '', expires: true, listDocumentId: '' }]);
    }
