...
const Fleet = () => {
  ...
  const vesselTypes = [
    ...
    "Draga",
    "Grúa flotante",
    "Unidad para cargue de tanqueros",
    "Muelle flotante",
    "Plataforma de producción, almacenamiento",
    "Plataforma autoelevadora",
    "Plataforma estabilizada por columnas",
    ...
    "Lancha de pilotos",
    "Buque de apoyo",
    "Buque de suministro costa afuera",
    "Plataforma de almacenamiento",
    "Plataforma de produccion, almacenamiento y/o descarga",
    "Arrastre de carga flotante",
